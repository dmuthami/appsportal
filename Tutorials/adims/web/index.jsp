<%-- 
    Document   : index
    Created on : 02-Apr-2017, 00:55:53
    Author     : dmuthami
--%>
...
<html>
    <head>
        ...
        <link href="src/v4_dist/ol.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="src/v4_dist/ol.js" type="text/javascript"></script>
